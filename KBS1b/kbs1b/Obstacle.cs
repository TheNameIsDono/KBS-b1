...
namespace kbs1b
{
    public class Obstacle
    {
        ...
        public void move(ref int yMax, ref int xMax, ref bool richtingDown, ref Player player) {
            switch(behaviour) {
                case 1: vertical_move(ref yMax, ref richtingDown); break;
                case 2: horizontal_move(ref xMax, ref richtingDown); break;
                case 3: following_move(ref player); break;
        ...
        /*
         ...
         Dit wordt bij elkaar opgeteld en de afstand wordt berekend door hiervan de wortel te nemen
             */
        private double GetDistanceBetweenTwoVectors(double playerXPos, double playerYPos) {
